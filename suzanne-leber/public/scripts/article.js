...
(function(module) {
  ...
  Article.numWordsAll = () => {
    ...
    // Grab number of words in each
    // Add the word count of each article together
    ...
    // console.log(Article.all.map(wordCount).reduce(reducer));
    console.log('wtf');
  };
  ...
  Article.prototype.insertRecord = function (callback) {
    ...
    // RESPONSE: Arrow functions cannot be used on prototypes because they have lexical scope, meaning the scope is only inside of this function.
